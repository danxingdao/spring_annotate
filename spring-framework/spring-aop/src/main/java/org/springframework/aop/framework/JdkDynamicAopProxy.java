...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		try {
			 ...
			 * 如果调用这个方法的clas或接口与参数cls表示的类或接口相同，
			 * 或者参数cla表示类或接口的父类，则返回true
			 * 形象的：自身类.class.isAssignableFrom(自身类或子类.class)返回true
			 * 例： ArrayList.class.isAssignableFrom(Object.class) // false
			...
			Object retVal;
			// 有时候目标对象内部的自我调用将无法实施切面中的增强代理则需要通过此属性暴露代理
			...
			if (chain.isEmpty()) {
				...
				// 拦截器封装在ReflectiveMethodInvocation，以便于使用其proceed进行链接表用拦截器
